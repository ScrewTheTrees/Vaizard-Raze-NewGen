...
while (startx<finalx)
    ...
    if startx<1000 or startx>room_width-1800 module=MODULE.FLAT //Start should always have some kind of ground
    else module=choose(MODULE.FLAT,MODULE.FLAT,MODULE.FLAT,MODULE.STAIR,MODULE.STAIR,MODULE.EMPTY);
